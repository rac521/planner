document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.getElementById("trip-title").textContent = `${trip.trip_name || "My Rajasthan Trip"}: Explore Rajasthan`;
    ...
    const itineraryData = itinerary.length ? itinerary : [
        { day_number: 1, location: "Jaipur", activities: ["Amer Fort", "Hawa Mahal"] },
        { day_number: 2, location: "Jodhpur", activities: ["Mehrangarh Fort", "Jaswant Thada"] }
    ];
